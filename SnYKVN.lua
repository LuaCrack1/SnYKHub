...
local Library = Update:Window("SnYK Hub","",Enum.KeyCode.RightControl);
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=16373597069";
      Title = "SnYK Infomation", 
      Text = "Cảm ơn đã dùng script!";
})
wait(3)
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=16373597069";
      Title = "SnYK Infomation", 
      Text = "Tạo Bởi Eric Roblox";
})
